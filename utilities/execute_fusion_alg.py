		...
		for j in range(0, maxFileNum):
			if fileList[i][j] != 'placeHolder':
				...
				if fileList[i][j] not in RP_deleted:
					...
					RP_deleted.append(fileList[i][j])
...
# 		print("writing to result")
		...
		outfile.write(datetime.fromtimestamp(res_ts) + "Room #1: " + res_count)
		outfile.close()
# 		print("Room 1:", int(res_count))
		...
		# print('python3 /home/team19/COSSY/utilities/voltage_room_1.py ' + str(int(res_count)))
